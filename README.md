...
[📚 官方文档](https://kitemc.com/zh/docs/verifymc/) | [🚀 更新日志](release_notes_zh.md)
...
而**GoldenCarrot-Web**则是基于此项目的修改分支，旨在加入更多符合**GoldenCarrot服务器**的功能，如集成完整的官网、CDN适配等等功能。
...
21. 🛠️ **游戏内管理命令**：新增 `/vmc` 指令集，支持在游戏内快速审核、封禁、解封玩家。
22. 🛡️ **增强安全性**：采用 SHA-256 + 盐值加密存储密码。
...
产物 jar：`plugin/target/verifymc-X.jar`
